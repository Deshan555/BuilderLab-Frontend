        ...
        .map((section, index) => (
          {
            ...
            subTitle: <span className='textStyles-small' style={{fontSize: '11px'}}>{section?.sessionName} <Badge status={section?.isActive === "true" ? 'success' : 'error'} text={section?.isActive === "true" ? 'Active' : 'Inactive'} /></span>,
            description: (
              <div>
