...
//   const initializeFormBuilder = (formData) => {
//     destroyFormBuilder(); 
...
useEffect(() => {
      ...
      fbInstance.promise.then(function (formBuilder) {
        ...
        let intervalId = setInterval(() => {
          ...
          if (JSON.stringify(newFormData) !== JSON.stringify(formDataJson)) {
            ...
            // Update formData with the new form data
            setFormDataJson(prevFormData => [...prevFormData, JSON.parse(newFormData)]);
  ...
  const destroyFormBuilder = () => {
    if (formBuilderInstanceRef.current) {
      formBuilderInstanceRef.current.actions.clearFields();
      formBuilderInstanceRef.current = null;
    }
  };
